...
#define strncpy(dest_in,src_in,count_in)\
({\
char * dest = dest_in;\
const char *src = src_in;\
int count = count_in;\
...
#define strncat(dest_in,src_in,count_in)\
({\
char * dest = dest_in;\
const char * src = src_in;\
int count = count_in;\
